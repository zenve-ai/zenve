...
class ApiKeyService:
    ...
    def create(self, workspace_id: str, data: ApiKeyCreate) -> tuple[ApiKeyRecord, str]:
    ...
    def list_by_org(self, workspace_id: str) -> list[ApiKeyRecord]:
        return self.db.query(ApiKeyRecord).filter(ApiKeyRecord.workspace_id == workspace_id).all()
